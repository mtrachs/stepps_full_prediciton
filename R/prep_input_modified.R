...
function (veg, pollen, target_taxa, grid, hood =7e+05, dist_scale = 1e+06) 
{
  ...
  #this used a rectangular grid that had more cells than vegetation cells (this causes problems for stan as cores can have higher indexes than the
